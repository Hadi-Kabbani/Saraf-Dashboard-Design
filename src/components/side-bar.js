    ...
    return (
        <div className={`relative p-0  flex flex-col  h-screen bg-white shadow-lg  ${isOpen ? 'min-w-14 sm:min-w-[25%]' : 'p-0 min-w-14'} duration-300 overflow-hidden`}>
            ...
            <div className='flex  items-center justify-center py-5'>
                <h3 className={`${isOpen ?"hidden sm:block opacity-1 duration-300":" hidden opacity-0 duration-300"}  text-4xl m-2 font-bold w-fit`}>saraf </h3>
                <img className='w-[40px] ' src='../382861-PC4AEH-765-fotor-bg-remover-2024090820913-removebg-preview.png' alt='' />
            </div>
