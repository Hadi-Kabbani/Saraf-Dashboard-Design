...
function Capital() {
    ...
    const totalCapital = deposits.reduce((acc, deposit) => acc + deposit.amount, 0);

    return (
        <div className="layout">
            <h1 className="text-2xl font-bold w-full mb-6 text-center"> رأس المال</h1>
            ...
            {isApear && (
                <div className="fixed z-10 inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md relative">
                        ...
                        <h2 className="text-xl font-semibold mb-4">إضافة رأس المال</h2>
            ...
            <div className="mt-6 p-4 bg-green-100 text-green-800 text-lg font-semibold rounded-lg text-center">
                إجمالي رأس المال: {totalCapital}
            </div>

            <h2 className="text-xl font-semibold mt-8 mb-4 text-center">قائمة مودع رأس المال</h2>
