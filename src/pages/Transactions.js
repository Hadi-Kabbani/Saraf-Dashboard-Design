...
const Transactions = ({ countryOptions }) => {
    ...
    return (
        <div className="flex flex-wrap justify-center overflow-auto w-full p-2 bg-gray-100 shadow-md rounded-lg">
            ...
            <div className="flex justify-center sm:w-full p-1">
                <button
                    ...
                    className="self-center h-fit w-fit px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                    تقديم
                </button>
            </div>
